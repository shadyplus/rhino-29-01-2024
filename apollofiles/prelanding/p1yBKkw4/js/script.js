...
let now = new Date,
    ...
    date = day + "." + mm + "." + year;
const massange = [{
    m: "مرحبا بكم في الإستشارة المجانية  عبر الإنترنت! أنا الطبيب   خوسيه إميليو. هنا أقوم بإجراء تشخيصات مجانية وتقنيات شخصية ساعدت الكثير من  الرجال على التخلص من مشاكل البروستات . "
}, {
...
function app() {
    ...
    const c = '<div class="chat-content-item manager "><div class="img-doc"><img src="apollofiles/prelanding/p1yBKkw4/img/header-ava-eac-arb.png" alt=""> </div><div class="chat-content-desc"><span class="doc-name">خوسيه إميليو</span><div class="chat-content-desc-item manager ch1"><p class="text text_img" id="mass' + mass_id + '"></p></div><p class="message-time" id="time">' + t + '</p></div></div>';
...
setTimeout(() => {
    var e = new Date,
        s = ("0" + e.getMinutes()).slice(-2);
    const t = '<div class="chat-content-item manager "><div class="img-doc"><img src="apollofiles/prelanding/p1yBKkw4/img/header-ava-eac-arb.png" alt=""> </div><div class="chat-content-desc"><span class="doc-name">خوسيه إميليو</span><div class="chat-content-desc-item manager ch1"><p class="text" id="mass' + mass_id + '"></p></div><p class="message-time" id="time">' + (("0" + e.getHours()).slice(-2) + ":" + s) + '</p></div></div>';
